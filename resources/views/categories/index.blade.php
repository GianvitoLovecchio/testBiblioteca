<x-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 px-4">
        ...
        <div class="md:col-span-2 ">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 my-8 border-r pt-4 pr-6">
                    ...
                    <div class="bg-white shadow rounded-lg p-4">
                        ...
                        <div class="mt-4 flex gap-2">
                            <a href="{{ route('category.edit', $category->id) }}"
                                class="flex-1 text-center rounded px-3 py-2 bg-blue-500 text-white text-sm font-semibold hover:bg-blue-600 transition-colors">
                                Modifica
                            </a>
                            <form action="{{ route('category.destroy', $category->id) }}" method="POST" class="flex-1">
                                ...
                                @method('DELETE')
                                <button type="submit"
                                    class="w-full rounded px-3 py-2 bg-red-500 text-white text-sm font-semibold hover:bg-red-600 transition-colors">
                                    Elimina
                                </button>
                            </form>
                        </div>
